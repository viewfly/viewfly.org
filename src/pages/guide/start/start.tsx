...
<p>通过命令行创建项目</p><pre lang="" theme="null" class="tb-pre"><div class="tb-pre-content"><div style="width:2.5em" class="tb-code-line-number-bg"></div><div class="tb-code-content"><div class="tb-code-line">viewfly new myApp</div></div><span class="tb-pre-lang"></span></div></pre>
