...
<ul>
  <li class="tb-list-item"><strong style="color:#1276cc"><span style="background-color:rgb(255, 255, 255)">JSX</span></strong><span style="background-color:rgb(255, 255, 255);color:rgb(73, 80, 96)">&nbsp;—— JSX 是 React 发明的一种声明式 UI 描述语言，其灵活的编写方式，丰富的表达能力，现在被大多数前端框架所采用，基本已成为前端 UI 描述语言的通用解决方案。</span></li>
  <li class="tb-list-item"><strong style="color:#1276cc"><span style="background-color:rgb(255, 255, 255)">函数组件</span></strong><span style="background-color:rgb(255, 255, 255);color:rgb(73, 80, 96)">&nbsp;—— 函数组件因其创建简单，使用灵活，备受前端开发人员青睐。</span></li>
  <li class="tb-list-item"><strong style="color:#1276cc"><span style="background-color:rgb(255, 255, 255)">依赖注入</span></strong><span style="background-color:rgb(255, 255, 255);color:rgb(73, 80, 96)">&nbsp;—— 依赖注入可以方便构建可拆分、可测试、架构健壮的应用。</span></li>
  <li class="tb-list-item"><span style="color:#1276cc"><strong><span style="background-color:rgb(255, 255, 255)">Signa</span></strong><span style="background-color:rgb(255, 255, 255)">l</span></span><span style="background-color:rgb(255, 255, 255);color:rgb(73, 80, 96)">&nbsp;—— Signal 的本质为一组相关联的 getter 和 setter，Signal 不会对原始数据做任何包装或更改。有利于构建大型复杂应用。</span></li>
  <li class="tb-list-item"><strong style="color:#1276cc"><span style="background-color:rgb(255, 255, 255)">TypeScript 兼容</span></strong><span style="background-color:rgb(255, 255, 255);color:rgb(73, 80, 96)">&nbsp;—— 由于 Viewfly 的组件本质是一堆函数，所以可以无缝和 TypeScript 集成，方便你写出类型安全的代码。</span></li>
</ul>
<p><br/></p></div>
    )
  }
