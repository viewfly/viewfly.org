  ...
  <div data-placeholder="" class="xnote-content">
    ...
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        ...
        <div class="xnote-list-content">Viewfly 通过 Signal 管理数据，通过调用获取 Signal 的数据，通过 &nbsp;signal.set 更新数据。</div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
    ...
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <div><span style="color:rgb(73, 80, 96)">我们相信，只使用普通的 JavaScript 一样可以编写出高质量、可维护、简单且容易扩展的代码。这也是我开发 Viewfly 的初衷。</span></div>
    </div>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <div><span style="color:rgb(73, 80, 96)">Viewfly 充分吸收了现有前端框架的一些优点，并在开发者使用层面有所体现，有：</span></div>
    </div>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:rgb(18, 118, 204)">独立 Hook</strong>&nbsp;—— createSignal、watch 等所有 hook 都可以在组件外使用，这让我们可以更灵活的组织组件和数据。</div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:rgb(18, 118, 204)">JSX</strong><span style="color:rgb(73, 80, 96)">&nbsp;—— JSX 是 React 发明的一种声明式 UI 描述语言，其灵活的编写方式，丰富的表达能力，现在被大多数前端框架所采用，基本已成为前端 UI 描述语言的通用解决方案。</span></div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:rgb(18, 118, 204)">函数组件</strong><span style="color:rgb(73, 80, 96)">&nbsp;—— 函数组件因其创建简单，使用灵活，备受前端开发人员青睐。</span></div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:rgb(18, 118, 204)">依赖注入</strong><span style="color:rgb(73, 80, 96)">&nbsp;—— 依赖注入可以方便构建可拆分、可测试、架构健壮的应用。</span></div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><span style="color:rgb(18, 118, 204)"><strong>Signa</strong>l</span><span style="color:rgb(73, 80, 96)">&nbsp;—— Signal 的本质为一组相关联的 getter 和 setter，Signal 不会对原始数据做任何包装或更改。有利于构建大型复杂应用。</span></div>
      </li>
    </ul>
    <ul data-component="ListComponent" style="margin-left:0px" class="xnote-list">
      <li>
        <div class="xnote-list-type"><span class="xnote-order-btn">•</span></div>
        <div class="xnote-list-content"><strong style="color:rgb(18, 118, 204)">TypeScript 兼容</strong><span style="color:rgb(73, 80, 96)">&nbsp;—— 由于 Viewfly 的组件本质是一堆函数，所以可以无缝和 TypeScript 集成，方便你写出类型安全的代码。</span></div>
      </li>
    </ul>
    <div data-component="ParagraphComponent" class="xnote-paragraph">
      <div><br/></div>
