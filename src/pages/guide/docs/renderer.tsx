...
<h2>Key</h2>
<p>对于列表渲染，我们可以通过给循环生成的节点添加 key 的方式来“优化”性能。相同 key 的元素会直接复用，而不是重新创建或删除。key 的值只可以是字符串字数字，且在相同层级内必须是唯一的。</p><pre lang="Jsx" theme="starry" class="tb-pre"><div class="tb-pre-content"><div style="width:2.5em" class="tb-code-line-number-bg"></div><div class="tb-code-content"><div class="tb-code-line">list.<span class="tb-hl-function">map</span>(item =&gt; {'{'}</div><div class="tb-code-line">&nbsp;&nbsp;<span class="tb-hl-keyword">return</span>&nbsp;&lt;<span class="tb-hl-tag">li&nbsp;</span><span class="tb-hl-attr-name">key</span>={'{'}item.id{'}'}&gt;xxxx&lt;/<span class="tb-hl-tag">li</span>&gt;</div><div class="tb-code-line">{'}'})</div></div><span class="tb-pre-lang">Jsx</span></div></pre>
